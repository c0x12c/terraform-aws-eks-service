...
| <a name="input_assume_custom_roles"></a> [assume\_custom\_roles](#input\_assume\_custom\_roles)                         | List of custom IAM assume role statements.           | <pre>list(object({<br/>    sid         = string<br/>    effect      = string<br/>    actions     = list(string)<br/>    type        = string<br/>    identifiers = list(string)<br/>    resources   = optional(list(string), null)<br/>    condition = optional(object({<br/>      test     = string<br/>      variable = string<br/>      values   = list(string)<br/>    }), null)<br/>  }))</pre>                                                                                       | `[]`    |    no    |
